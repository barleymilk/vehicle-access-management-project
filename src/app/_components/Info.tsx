...
export const Info = ({ vehicleData, driverData }: InfoProps) => {
  ...
  return (
    <>
      ...
      <FixedBottomButton>출입 기록 작성</FixedBottomButton>
    </>
  );
};
